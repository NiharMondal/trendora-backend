...
-- AddForeignKey
ALTER TABLE "public"."Size" ADD CONSTRAINT "Size_sizeGroupId_fkey" FOREIGN KEY ("sizeGroupId") REFERENCES "public"."SizeGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
