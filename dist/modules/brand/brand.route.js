...
router
    .route("/")
    .post((0, authGuard_1.authGuard)(prisma_client_1.Role.ADMIN), (0, validateRequest_1.validateRequest)(brand_validation_1.brandSchema), brand_controller_1.brandControllers.createIntoDB)
