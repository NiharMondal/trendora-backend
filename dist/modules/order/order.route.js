...
(0, authGuard_1.authGuard)(prisma_client_1.Role.CUSTOMER, prisma_client_1.Role.VENDOR, prisma_client_1.Role.ADMIN), order_controller_1.orderControllers.getOrderById);
router
    .route("/")
    .post((0, authGuard_1.authGuard)(prisma_client_1.Role.CUSTOMER, prisma_client_1.Role.VENDOR, prisma_client_1.Role.ADMIN), (0, validateRequest_1.validateRequest)(order_validation_1.orderValidation.createOrderSchema), order_controller_1.orderControllers.createOrder)
    .get((0, authGuard_1.authGuard)(prisma_client_1.Role.ADMIN), order_controller_1.orderControllers.findAllFromDB);
